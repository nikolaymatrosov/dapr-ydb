...
// NOTE: connection/auth parsing and the authMethod → credential-option mapping
// (including the Yandex Cloud serviceAccountKey/metadata paths and useInternalCA)
// now live in internal/ydbconfig and are tested in ydbconfig/config_test.go.
